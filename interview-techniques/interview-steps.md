...
1.  [Requirements Analysis](/interview-techniques/requirement-analysis.md)
...
2.  [Capacity Estimation](/interview-techniques/capacity-estimation.md)
    - Request
        - Daily active user
        - Peak load
    - Bandwidth
    ...
    - Storage
        ...
        - Number of replica
3.  [Data Model](/interview-techniques/data-model.md)
    - ER diagram
    - Database schema
    - Choice of database
4.  [API Design](/interview-techniques/api-design.md)
    - Use REST
    - Ask about graphql
    - Ask about gRPC
5.  [System Design](/interview-techniques/system-design.md)
    - System design diagram
6.  [Design Discussion](/interview-techniques/design-discussion.md)
